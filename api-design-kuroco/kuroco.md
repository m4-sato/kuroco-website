...
＜参考情報＞
https://kuroco.app/ja/docs/tutorials/how-to-implement-cutom-body-search/

＜チュートリアル＞
https://kuroco.app/ja/docs/tutorials/implement-a-search-function/
...
＜チュートリアル 1 ＞
https://kuroco.app/ja/docs/tutorials/how-to-use-swagger-ui/

＜チュートリアル 2 ＞
https://kuroco.app/ja/docs/tutorials/restricting-api-access-with-statictoken/
...
＜参考情報＞
https://kuroco.app/ja/docs/tutorials/how-to-use-workflow/

##### 3-1-0. 事前準備

- 編集者用、承認者用のアカウントそれぞれ 1 つ
